...
namespace MVCReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            ViewBag.CategoryID = new SelectList(db.Categories, "ID", "PlaceCategory");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Location,Title,CustomerReview,VisitDate,Recommend,CategoryID")] Review review)
        {
            ...
            ViewBag.CategoryID = new SelectList(db.Categories, "ID", "PlaceCategory", review.CategoryID);
            return View(review);
        }
